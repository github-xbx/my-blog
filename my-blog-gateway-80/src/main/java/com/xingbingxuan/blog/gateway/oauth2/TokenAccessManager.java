...
import com.xingbingxuan.blog.gateway.service.RequestUrlService;
...
@Slf4j
@Component
public class TokenAccessManager implements ReactiveAuthorizationManager<AuthorizationContext> {
    ...
    public TokenAccessManager() {
        ...
        permitAll.add("/api/blog/getBlogPage/**");
    }
    ...
    public Mono<AuthorizationDecision> check(Mono<Authentication> authenticationMono, AuthorizationContext authorizationContext) {
        ...
        RequestUrl requestUrl = requestUrlDao.findByRequestUrl(requestPath);

        // 是否直接放行
        if (!requestUrl.getRequestIsAuth()) {
